...
namespace etw
{
    ...
    {
        debug::DebugLogW(L"Get SERVICE_CONTROL_STOP");
        ...
        if (SetServiceStatus (status_handle_, &service_status_) == FALSE){
            debug::DebugLogW(L"Failed to SetServiceStatus SERVICE_STOP_PENDING");
            exit(0);
        }
        ...
        if (SetServiceStatus (status_handle_, &service_status_) == FALSE){
            debug::DebugLogW(L"Failed to SetServiceStatus SERVICE_STOPPED after SERVICE_STOP_PENDING");
            exit(0);
        }
    ...
    {
        debug::DebugLogW(L"Get SERVICE_CONTROL_PAUSE");
        ...
        if (SetServiceStatus (status_handle_, &service_status_) == FALSE){
            debug::DebugLogW(L"Failed to SetServiceStatus SERVICE_PAUSE_PENDING");
            exit(0);
        }
        ...
        if (SetServiceStatus (status_handle_, &service_status_) == FALSE){
            debug::DebugLogW(L"Failed to SetServiceStatus SERVICE_PAUSED after SERVICE_PAUSE_PENDING");
            exit(0);
        }
    ...
    {
        debug::DebugLogW(L"Get SERVICE_CONTROL_CONTINUE");
        ...
        if (SetServiceStatus (status_handle_, &service_status_) == FALSE){
            debug::DebugLogW(L"Failed to SetServiceStatus SERVICE_CONTINUE_PENDING");
            exit(0);
        }
        ...
        if (SetServiceStatus (status_handle_, &service_status_) == FALSE){
            debug::DebugLogW(L"Failed to SetServiceStatus SERVICE_RUNNING after SERVICE_CONTINUE_PENDING");
            exit(0);
        }
    ...
    {
        debug::DebugLogW(L"Get SERVICE_CONTROL_SHUTDOWN");
    ...
    void ProcessMonitoringService::ProcessMonitoringServiceCtrlHandler(DWORD ctrl_code)
    {
        switch (ctrl_code)
        {
            ...
            default:
                ...
                debug::DebugLogW(L"Get service control code: " + ctrl_code);
                break;
        }
    ...
    VOID WINAPI ProcessMonitoringService::ProcessMonitoringServiceMain()
    {
        ...
        {
            debug::DebugLogW(L"Can not RegisterServiceCtrlHandler: " + GetLastError());
            goto EXIT;
        }
        ...
        if (SetServiceStatus (status_handle_ , &service_status_) == FALSE)
        {
            debug::DebugLogW(L"Can not SetServiceStatus in line 218: " + GetLastError());
            goto EXIT;
        }
        ...
        */
        ...
        if (SetServiceStatus(status_handle_, &service_status_) == FALSE)
        {
            debug::DebugLogW(L"Can not SetServiceStatus in line 253: " + GetLastError());
        }
